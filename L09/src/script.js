...
const cubeTweak = gui.addFolder('Cute cube')
cubeTweak.close()

cubeTweak.add(mesh.position, 'y').min(-3).max(2).step(0.01).name('elevation')
...
cubeTweak.onFinishChange(() => {
    mesh.geometry.dispose()
    mesh.geometry = new THREE.BoxGeometry(1, 1, 1,
         debugObject.subdivision, debugObject.subdivision, 
