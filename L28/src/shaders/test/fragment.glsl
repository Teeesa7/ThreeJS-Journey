...
void main()
{
   ...
   // gl_FragColor = vec4(strength, strength, strength, 1.0);
    ...
    // // Pattern 31
    //  vec2 lightUvX = vec2(
    //     vUv.x * 0.2 + 0.4, vUv.y * 0.5 + 0.25
    //  );
    //  float lightX =  0.015  / distance(lightUvX, vec2(0.5));

    //  vec2 lightUvY = vec2(
    //     vUv.y * 0.2 + 0.4, vUv.x * 0.5 + 0.25
    //  );
 ...
 // Pattern 32
    ...
    //  vec2 lightUvX = vec2(
    //     rotatedUv.x * 0.2 + 0.4, vUv.y * 0.5 + 0.25
    //  );
    //  float lightX =  0.015  / distance(lightUvX, vec2(0.5));

    //  vec2 lightUvY = vec2(
    //     rotatedUv.y * 0.2 + 0.4, vUv.x * 0.5 + 0.25
    //  );
...
// // Pattern 33
// float strength = distance(vUv, vec2(0.5));
// gl_FragColor = step(0.3, vec4(strength, strength, strength, 1.0));
...
// // Pattern 35
// float strength = abs(distance(vUv, vec2(0.5)) - 0.25);
// gl_FragColor = step(0.01, vec4(strength, strength, strength, 1.0));
...
// Pattern 49 - ANIMATE
// float strength = sin(cnoise(vUv * 20.0) * 10.0);
// gl_FragColor = vec4(strength, strength, strength, 1.0);
